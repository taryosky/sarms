class AssignmentsController < ApplicationController
	...
	def path
		...
		ccode_id = params[:assign][:course_id]
		end_date = params[:assign][:submission_date]
		topic = params[:assign][:topic]
		if topic.blank? || ccode_id.blank? || end_date.blank? || file.blank?
